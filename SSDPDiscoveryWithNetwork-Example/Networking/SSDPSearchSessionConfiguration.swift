...
extension SSDPSearchSessionConfiguration {
    ...
    static func createMulticastConfiguration(forSearchTarget searchTarget: String, maximumWaitResponseTime: TimeInterval = 5, maximumBroadcastsBeforeClosing: UInt = 3) -> SSDPSearchSessionConfiguration {
